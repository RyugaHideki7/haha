                ...
                <div className="my-auto mx-5">
                    <div className="form-control ">
                        ...
                        <label className="input-group">
                            <span><i className="iconly-Call text-3xl text-white"></i></span>
                            <input type="text" placeholder="Téléphone" className="input input-bordered w-full"/>
                        </label>
                        ...
                        <label className="input-group">
                            <span><i className="iconly-Message text-3xl text-white"></i></span>
